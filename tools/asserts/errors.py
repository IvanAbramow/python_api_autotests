...
from schemas.error import ValidationErrorSchema, ValidationErrorResponseSchema, InternalErrorResponseSchema
...
@allure.step("Check validation error response body")
...
@allure.step("Check internal error detail")
